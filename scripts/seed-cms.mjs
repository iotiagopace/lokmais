...
const planos = [
  {
    ...
    nome: "Trimestral",
    category: "Trimestral",
    subtitulo: "3 meses de aluguel · ideal para comecar.",
    preco_semanal: "265",
    duracao: "3 meses",
    tabela_precos: "Start 160 · 2024 | R$ 265,00\nFan 160 · 2025 | R$ 315,00\nStart 160 · 2025 | R$ 335,00",
    features: "Honda Start 160 ou Fan 160\nManutencao inclusa\nCaucao R$ 800 reembolsavel\nSem consulta a SPC/Serasa",
    destaque: "Nao",
    display_order: 10,
  },
  {
    ...
    nome: "30 meses",
    category: "30 meses",
    subtitulo: "A moto roda com voce no caminho de ser sua.",
    preco_semanal: "419,90",
    duracao: "30 meses",
    tabela_precos: "Start 160 Semi Nova | R$ 419,90\nFan 2026 · 0 km | R$ 449,90\nStart 160 · 0 km | R$ 465,90",
    features: "Honda 0 km ou seminova\nFreio a disco e roda de liga\nManutencao inclusa\nCaucao R$ 800 reembolsavel",
    destaque: "Sim",
  ...
  },
  {
    ...
    nome: "36 meses",
    category: "36 meses",
    subtitulo: "Menor parcela semanal · prazo estendido.",
    preco_semanal: "399,90",
    duracao: "36 meses",
    tabela_precos: "Start 160 Semi Nova | R$ 399,90\nFan 2026 · 0 km | R$ 419,90\nStart 160 · 0 km | R$ 444,90",
...
const faq = [
  ...
  ["Motos", "Posso escolher a moto?", "Sim, conforme disponibilidade da unidade. O simulador mostra quais motos estao em cada plano."],
  ["Motos", "Por que so Honda?", "Honda lidera o mercado em durabilidade, baixo custo de manutencao e valorizacao."],
  ["Pagamento", "Como funciona a caucao?", "Caucao unica de R$ 800 em todos os planos, reembolsavel ao fim do contrato conforme as condicoes de devolucao."],
